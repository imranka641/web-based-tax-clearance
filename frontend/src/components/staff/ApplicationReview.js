      ...
      <Row>
        <Col>
          <div className="d-flex justify-content-between align-items-center mb-4">
            ...
            <Button variant="outline-secondary" onClick={() => navigate('/staff/applications')}>
                      ...
                      <Row className="mt-2">
                        <Col md={6}>
                          ...
                          <Badge bg={compliance.outstanding_balance === 0 ? 'success' : 'danger'}>
                            ETB {compliance.outstanding_balance?.toLocaleString() || 0}
                          </Badge>
                        </Col>
                        <Col md={6}>
                ...
                <Card.Body>
                  <div className="d-grid gap-2">
                    <Button 
                      ...
                      disabled={actionLoading || (compliance && !compliance.is_compliant)}
                    >
                      {actionLoading ? (
                        <>
                          <Spinner
